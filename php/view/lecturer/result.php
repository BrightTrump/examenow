                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <table class="table table-responsive">
                      ...
                      <tbody>
                        <?php
                        $tests = $test->getTestScheduled($user_id);
                        
                        $i = 1;
                        foreach ($tests as $test) {
                            echo '<tr>';
                            echo '<td>' . $i++ . '</td>';
                            echo '<td>' . $course->courseDetails($test['course_id'])['course_name'] . '</td>';
                            echo '<td>' . $test['test_title'] . '</td>';
                            echo '<td>' . $test['test_description'] . '</td>';
                            echo '<td>' . $test['test_duration'] . '</td>';
                            echo '<td>' . $test['test_time'] . '</td>';
                            echo '<td>' . $test['createdAt'] . '</td>';
                            echo '<td>
                                    <a href="scores.php?id=' . $test['id'] . '" class="btn btn-success btn-sm">View Scores</a>
                                  </td>';
                            echo '</tr>';
                        }
                        ?>
