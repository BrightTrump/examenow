              ...
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    <h2 class="card-title">View and Download Test Scores</h2>
                    <a href="download.php?id=<?php echo $test_id; ?>" class="btn btn-primary btn-sm">Download</a>
                  </div>
                </div>
              </div>
                      ...
                      <tbody>
                          <?php
                            ...
                            foreach ($test_results as $result) {
                                echo '<tr>';
                                echo '<td>' . $i++ . '</td>';
                                echo '<td>' . $result['matno']. '</td>';
                                echo '<td>' . $result['performance'] . '</td>';
                                echo '</tr>';
                            }
                          ?>
                      </tbody>
