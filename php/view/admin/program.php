              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4 offset-md-4">
                    <form method="post" action="../../controller/createprogram.php">
                      ...
                      <div class="form-group">
                        <label for="departmentOption">Department Option</label>
                        <input type="text" class="form-control" name="departmentOption"
                          placeholder="Enter department option">
                      </div>

                      <div class="form-group">
                        <label for="departmentLevel">Level</label>
                        <select name="departmentLevel" name="departmentLevel" class="form-control bg-dark">
